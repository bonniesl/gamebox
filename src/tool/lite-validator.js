...
function validForm(formEl, fieldsRules, validAll) {
    // 获取 Deferred 对象
    // 过滤隐藏和禁用的字段
    let regFieldsDom = getFields(formEl, fieldsRules),
        regFieldsRules = {};
